...
test("[test-suite] vararg: new-style varargs", function (t) {
    let luaCode = `
...
test("[test-suite] vararg: varargs for main chunks", function (t) {
    let luaCode = `
        f = load[[ return {...} ]]
        x = f(2,3)
...
test("[test-suite] vararg: bug in 5.2.2", function (t) {
    let luaCode = `
